...
label = ttk.Label(
    frame, text="Enter a sentence:", font=("Arial", 14), style="My.TLabel"
)  # Change font and use a custom style
label.grid(column=0, row=0, sticky=tk.W, pady=10)

entry = ttk.Entry(
    frame, width=30, font=("Arial", 12), style="My.TEntry"
)  # Change font and use a custom style
entry.grid(column=0, row=1, sticky=tk.W, pady=10)

analyze_button = ttk.Button(
    frame, text="Analyze", command=on_analyze_button_click, style="My.TButton"
)  # Use a custom style
analyze_button.grid(column=1, row=1, sticky=tk.W, pady=10)

result_label = ttk.Label(
    frame, text="", font=("Arial", 16, "bold"), foreground="blue", style="My.TLabel"
)  # Change font and use a custom style
...
style.configure(
    "My.TLabel", font=("Arial", 12), background="#f0f0f0"
)  # Set background color
style.configure(
    "My.TEntry", font=("Arial", 12), background="#e0e0e0"
)  # Set background color
style.configure(
    "My.TButton", font=("Arial", 12, "bold"), background="#4caf50", foreground="white"
